...
func (msg *XfrmSelector) write(b []byte) {
	...
	nativeEndian.PutUint16(b[AddrEnd:AddrEnd+2], msg.Dport)
	nativeEndian.PutUint16(b[AddrEnd+2:AddrEnd+4], msg.DportMask)
	nativeEndian.PutUint16(b[AddrEnd+4:AddrEnd+6], msg.Sport)
	nativeEndian.PutUint16(b[AddrEnd+6:AddrEnd+8], msg.SportMask)
	nativeEndian.PutUint16(b[AddrEnd+8:AddrEnd+10], msg.Family)
	b[AddrEnd+10] = msg.PrefixlenD
	b[AddrEnd+11] = msg.PrefixlenS
	b[AddrEnd+12] = msg.Proto
	copy(b[AddrEnd+13:AddrEnd+16], msg.Pad[:])
	nativeEndian.PutUint32(b[AddrEnd+16:AddrEnd+20], uint32(msg.Ifindex))
	nativeEndian.PutUint32(b[AddrEnd+20:AddrEnd+24], msg.User)
}
...
func (msg *XfrmLifetimeCfg) write(b []byte) {
	nativeEndian.PutUint64(b[0:8], msg.SoftByteLimit)
	nativeEndian.PutUint64(b[8:16], msg.HardByteLimit)
	nativeEndian.PutUint64(b[16:24], msg.SoftPacketLimit)
	nativeEndian.PutUint64(b[24:32], msg.HardPacketLimit)
	nativeEndian.PutUint64(b[32:40], msg.SoftAddExpiresSeconds)
	nativeEndian.PutUint64(b[40:48], msg.HardAddExpiresSeconds)
	nativeEndian.PutUint64(b[48:56], msg.SoftUseExpiresSeconds)
	nativeEndian.PutUint64(b[56:64], msg.HardUseExpiresSeconds)
}
...
func (msg *XfrmLifetimeCur) write(b []byte) {
	nativeEndian.PutUint64(b[0:8], msg.Bytes)
	nativeEndian.PutUint64(b[8:16], msg.Packets)
	nativeEndian.PutUint64(b[16:24], msg.AddTime)
	nativeEndian.PutUint64(b[24:32], msg.UseTime)
}
